...
namespace accountingProject.EstadoResultado
{
    public class EstadoResultado
    {


        public static void Ingresosleer(out decimal VentasTotales, out decimal Devoluciones, out decimal RebajasSobreVentas, out decimal Descuentos)
        {
            VentasTotales = 0m;
            Devoluciones = 0m;
       ...
       public  static void CostosLeer(out decimal Compras, out decimal GastosDeCompra, out decimal DevolucionesSobreCompra, out decimal RebajasSobreCompras, out decimal DescuentoSobreCompra, out decimal InventarioInicial, out decimal InventarioFinal)
        {
            Compras = 0m;
            GastosDeCompra = 0m;
       ...
       public static void GastosDeAdministracionLeer(out decimal SueldoDeGerente, out decimal ServiciosBasicosVentas, out decimal SueldoDeViceGerente, out decimal SueldoDeContador, out decimal SueldoDelPersonalDeOficina, out decimal SeguroSocialDelPersonal, out decimal ConsumoDePapeleríaYUtilesDeEscritorio, out decimal GastosDeCoreoYTelegrafo, out decimal AlquilerDeOficina, out decimal GastosDeDepreciacion)
        ...
        public static void GastosFinancieros(out decimal InteresesSobreDocumentos, out decimal DescuentoPorPagoAnticipado, out decimal InteresesSobrePrestamosBancarios, out decimal PerdidasOUtilidadesQueResultenDelIntercambioDeMonedaExtrangera)
        {
        ...
        public static void EgresosLeer(out decimal InteresesPagados, out decimal ServiciosBancarios, out decimal RentasCobradas, out decimal PerdidasoUtilidadesEnVentaDeVariosActivosFijo, out decimal PerdidasoUtilidadesEnCompraDeActivos, out decimal RentasPagadas, out decimal DividendoDeAcciones, out decimal ComisionesCobradas)
        {
            InteresesPagados = 0m;
       ...
       public static void OtrosIngresosLeer(out decimal InteresesCobrados, out decimal DividendosCobrados)
        {
        ...
        public static void TotalVentasNetas(decimal VentasTotales, decimal Devoluciones, decimal RebajasSobreVentas, decimal Descuentos, out decimal TotalVentasN)
        {
            TotalVentasN = 0m;
        ...
        public static void TotalComprasNetas(decimal Compras, decimal MercanciaDisponible, decimal GastosDeCompra, decimal DevolucionesSobreCompra, decimal RebajasSobreCompras, decimal DescuentoSobreCompra, decimal InventarioInicial, decimal InventarioFinal, out decimal TotalComprasN)
        {
        ...
        public static void CalcUtilidadBruta(decimal TotalVentasN, decimal TotalComprasN, out decimal UtilidadBruta)
        {
            UtilidadBruta = 0m;
        ...
        public static void TotalGastosDeAdministración(decimal SueldoDeGerente, decimal SueldoDeViceGerente, decimal SueldoDeContador, decimal SueldoDelPersonalDeOficina, decimal SeguroSocialDelPersonal, decimal ConsumoDePapeleríaYUtilesDeEscritorio, decimal GastosDeCoreoYTelegrafo, decimal AlquilerDeOficina, decimal GastosDeDepreciacion, out decimal TotalGastosAdmin)
        {
            TotalGastosAdmin = 0m;
        ...
        public static void TotalGastosFinancieros(decimal InteresesSobreDocumentos, decimal DescuentoPorPagoAnticipado, decimal InteresesSobrePrestamosBancarios, decimal PerdidasOUtilidadesQueResultenDelIntercambioDeMonedaExtrangera, out decimal TotalGastosFi)
        {
            TotalGastosFi = 0m;
        ...
        public static void CalcUtilidadDeOperación(decimal TotalGastosV, decimal TotalGastosAdmin, decimal TotalGastosFi, decimal UtilidadBruta, out decimal UtilidadDeOperación)
        {
        ...
        public static void TotalOtrosIngresos(decimal InteresesCobrados, decimal DividendosCobrados, out decimal TotalOI)
        {
            TotalOI = 0m;
        ...
        public static void CalcUtilidadAntesdeISR(decimal TotalOI, decimal UtilidadDeOperacion, decimal TotalOtrosGastos, out decimal UtilidadAntesDeImpuesto)
        {
        ...
        public static void Pregunta(out decimal ISR)
        {
            ISR = 0m;
        ...
        public static void CalcUtilidadNeta(decimal ISR, decimal UtilidadAntesDeImpuesto, out decimal UtilidadNeta)
        {
            UtilidadNeta = 0m;
